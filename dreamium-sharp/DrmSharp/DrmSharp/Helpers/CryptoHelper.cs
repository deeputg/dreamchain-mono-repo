    ...
    public class CryptoHelper
    {
        ...
        public static KeyPair GenerateKeyPair(string keyType = "sha256x2")
        {
            ...
            return new KeyPair()
            {
                ...
                PublicKey = KeyToString(pubKey, keyType != "sha256x2" ? keyType : null, keyType == "R1" ? "PUB_R1_" : "DRM")
            };
        }
        ...
        public static string PubKeyBytesToString(byte[] keyBytes, string keyType = null, string prefix = "DRM")
        {
        ...
        /// </summary>
        /// <param name="privKey">privatekey string</param>
        /// <returns>publickey string</returns>
        public static string PrivKeyToPubKey(string privKey)
        {
            var bytes = GetPrivateKeyBytesWithoutCheckSum(privKey);
            var pubBytes = Secp256K1Manager.GetPublicKey(bytes,true);
            var pubKey = PubKeyBytesToString(pubBytes);
            return pubKey;
        ...
        public static byte[] PubKeyStringToBytes(string key, string prefix = "DRM")
        {

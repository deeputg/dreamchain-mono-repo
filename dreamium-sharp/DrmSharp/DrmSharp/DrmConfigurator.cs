...
{
    /// <summary>
    /// Aggregates all properties to configure Drm client
    /// </summary>
    public class DrmConfigurator
    {
        /// <summary>
        /// http or https location of a noddrmd server providing a chain API.
        /// </summary>
        ...
        /// <summary>
        /// number of seconds before the transaction will expire. The time is based on the noddrmd's clock. 

...
describe('offline', function() {
    ...
    it('transactionHeaders object', function _callee4() {
        var eos, memo, trx;
...
describe('Contracts', function() {
    it('Messages do not sort', function _callee6() {
        var local, opts, tx;
...
describe('Contract', function() {
    function deploy(contract) {
        ...
        it('deploy ' + contract + '@' + account, function _callee7() {
...
describe('keyProvider', function() {
    ...
    it('per-action', function _callee10() {
        var eos, token;
    ...
    it('return Promise', function() {
        var eos = Eos({
            keyProvider: new Promise(function(resolve) {
                resolve(wif);
            })
        });
...
describe('transactions', function() {
    ...
    it('create asset', function _callee11() {
        var eos, pubkey, auth;
    ...
    it('transfer custom authorization (permission only)', function _callee12() {
        var eos, tr;
    ...
    it('transfer custom global authorization', function _callee13() {
    ...
    it('action to contract atomic', function _callee14() {
            ...
            while (1) {
                switch (_context14.prev = _context14.next) {
                    case 0:
                        ...
                        _context14.t0 = _regenerator2.default;
                        _context14.t1 = assertTr;
                        _context14.next = 8;
                    ...
                    case 12:
                        _context14.t4 = _regenerator2.default;
                        _context14.t5 = assertTr;
                        _context14.next = 16;
                    ...
                    case 16:
                        ...
                        _context14.next = 20;
                        return _context14.t4.awrap.call(_context14.t4, _context14.t7);
    ...
    it('custom contract transfer', function _callee15() {
        var eos;
...
it('Transaction ABI cache', function _callee16() {
    var eos, abi;
        ...
        while (1) {
            switch (_context16.prev = _context16.next) {
                ...
                case 9:
                    ...
                    _context16.t0.deepEqual.call(_context16.t0, _context16.t1, _context16.t2);
...
it('Transaction ABI lookup', function _callee17() {
    var eos, tx;

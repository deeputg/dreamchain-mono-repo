...
describe('Common API', function () {
  it('unsafeRandomKey', function _callee() {
    var pvt;
    return _regenerator2.default.async(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _regenerator2.default.awrap(ecc.unsafeRandomKey());

          case 2:
            pvt = _context.sent;

            assert.equal(typeof pvt === 'undefined' ? 'undefined' : (0, _typeof3.default)(pvt), 'string', 'pvt');

...
{
   fc::variant act_payload = fc::mutable_variant_object()("payer", creator.to_string())("receiver", newaccount.to_string())("quant", quantity.to_string());
...
{
   fc::variant act_payload = fc::mutable_variant_object()("payer", creator.to_string())("receiver", newaccount.to_string())("bytes", numbytes);
   return create_action(get_account_permissions(tx_permission, {creator, config::active_name}),
...
{
   fc::variant act_payload = fc::mutable_variant_object()("from", from.to_string())("receiver", receiver.to_string())("stake_net_quantity", net.to_string())("stake_cpu_quantity", cpu.to_string())("transfer", transfer);
...
{
   return fc::mutable_variant_object()("producer", producer)("producer_key", key)("url", url)("location", location);
}
...
chain::action create_transfer(const string &contract, const name &sender, const name &recipient, asset amount, const string &memo)
{
   ...
   auto transfer = fc::mutable_variant_object("from", sender)("to", recipient)("quantity", amount)("memo", memo);
...
asset to_asset(account_name code, const string &s)
{
   ...
   if (it == cache.end())
   {
      auto json = call(get_currency_stats_func, fc::mutable_variant_object("json", false)("code", code)("symbol", sym_str));
                     ...
                     if (itr2 != auth.accounts.end() && itr2->permission == code_perm)
                     {
                        ...
                        if ((*itr2).weight < auth.threshold)
                        {
                           ...
                           std::cerr << localized("The weight of '${actor}@${code}' in '${permission}' permission authority will be increased up to threshold",
                                                  ("actor", actor)("code", code_name)("permission", permission))
                                     << std::endl;
                        ...
                        else
                        {
                           std::cerr << localized("ERROR: The permission '${permission}' already contains '${actor}@${code}'",
                                                  ("permission", permission)("actor", actor)("code", code_name))
                                     << std::endl;
                           return;
                        }
                     }
   ...
   create_account_subcommand(CLI::App *actionRoot, bool s) : simple(s)
   {
      ...
      if (!simple)
      {
         createAccount->add_option("--stake-net", stake_net,
                                   (localized("The amount of tokens delegated for net bandwidth")))
             ->required();
         createAccount->add_option("--stake-cpu", stake_cpu,
                                   (localized("The amount of tokens delegated for CPU bandwidth")))
             ->required();
...
struct unregister_producer_subcommand
{
   ...
   unregister_producer_subcommand(CLI::App *actionRoot)
   {
      ...
      unregister_producer->set_callback([this] {
         fc::variant act_payload = fc::mutable_variant_object()("producer", producer_str);
...
struct vote_producer_proxy_subcommand
{
   ...
   vote_producer_proxy_subcommand(CLI::App *actionRoot)
   {
      ...
      vote_proxy->set_callback([this] {
         fc::variant act_payload = fc::mutable_variant_object()("voter", voter_str)("proxy", proxy_str)("producers", std::vector<account_name>{});
...
struct vote_producers_subcommand
{
   ...
   vote_producers_subcommand(CLI::App *actionRoot)
   {
      ...
      vote_producers->set_callback([this] {
         ...
         fc::variant act_payload = fc::mutable_variant_object()("voter", voter_str)("proxy", "")("producers", producer_names);
         auto accountPermissions = get_account_permissions(tx_permission, {voter_str, config::active_name});
         send_actions({create_action(accountPermissions, config::system_account_name, N(voteproducer), act_payload)});
      });
   }
...
struct approve_producer_subcommand
{
   ...
   approve_producer_subcommand(CLI::App *actionRoot)
   {
      ...
      approve_producer->set_callback([this] {
         auto result = call(get_table_func, fc::mutable_variant_object("json", true)("code", name(config::system_account_name).to_string())("scope", name(config::system_account_name).to_string())("table", "voters")("table_key", "owner")("lower_bound", voter.value)("upper_bound", voter.value + 1)
         ...
         fc::variant act_payload = fc::mutable_variant_object()("voter", voter)("proxy", "")("producers", prods);
...
struct list_producers_subcommand
{
   ...
   list_producers_subcommand(CLI::App *actionRoot)
   {
      ...
      list_producers->set_callback([this] {
         auto rawResult = call(get_producers_func, fc::mutable_variant_object("json", true)("lower_bound", lower)("limit", limit));
         if (print_json)
         {
...
struct delegate_bandwidth_subcommand
{
   ...
   delegate_bandwidth_subcommand(CLI::App *actionRoot)
   {
      ...
      delegate_bandwidth->set_callback([this] {
         fc::variant act_payload = fc::mutable_variant_object()("from", from_str)("receiver", receiver_str)("stake_net_quantity", to_asset(stake_net_amount))("stake_cpu_quantity", to_asset(stake_cpu_amount))("transfer", transfer);
...
struct undelegate_bandwidth_subcommand
{
   ...
   undelegate_bandwidth_subcommand(CLI::App *actionRoot)
   {
      ...
      undelegate_bandwidth->set_callback([this] {
         fc::variant act_payload = fc::mutable_variant_object()("from", from_str)("receiver", receiver_str)("unstake_net_quantity", to_asset(unstake_net_amount))("unstake_cpu_quantity", to_asset(unstake_cpu_amount));
         auto accountPermissions = get_account_permissions(tx_permission, {from_str, config::active_name});
...
struct bidname_subcommand
{
   ...
   bidname_subcommand(CLI::App *actionRoot)
   {
      ...
      bidname->set_callback([this] {
         fc::variant act_payload = fc::mutable_variant_object()("bidder", bidder_str)("newname", newname_str)("bid", to_asset(bid_amount));
...
struct bidname_info_subcommand
{
   ...
   bidname_info_subcommand(CLI::App *actionRoot)
   {
      ...
      list_producers->set_callback([this] {
         auto rawResult = call(get_table_func, fc::mutable_variant_object("json", true)("code", "eosio")("scope", "eosio")("table", "namebids")("lower_bound", newname.value)("upper_bound", newname.value + 1)
                               // Less than ideal upper_bound usage preserved so cleos can still work with old buggy nodeos versions
         ...
         if (bid < 0)
            std::cout << "This auction has already closed" << std::endl;
      });
   }
};
...
struct list_bw_subcommand
{
   ...
   list_bw_subcommand(CLI::App *actionRoot)
   {
      ...
      list_bw->set_callback([this] {
         ...
         auto result = call(get_table_func, fc::mutable_variant_object("json", true)("code", name(config::system_account_name).to_string())("scope", account.to_string())("table", "delband"));
         if (!print_json)
         {
            auto res = result.as<eosio::chain_apis::read_only::get_table_rows_result>();
            if (!res.rows.empty())
...
struct sellram_subcommand
{
   ...
   sellram_subcommand(CLI::App *actionRoot)
   {
      ...
      sellram->set_callback([this] {
         fc::variant act_payload = fc::mutable_variant_object()("account", receiver_str)("bytes", amount);
...
struct regproxy_subcommand
{
   ...
   regproxy_subcommand(CLI::App *actionRoot)
   {
      ...
      register_proxy->set_callback([this] {
         fc::variant act_payload = fc::mutable_variant_object()("proxy", proxy)("isproxy", true);
...
struct unregproxy_subcommand
{
   ...
   unregproxy_subcommand(CLI::App *actionRoot)
   {
      ...
      unregister_proxy->set_callback([this] {
         fc::variant act_payload = fc::mutable_variant_object()("proxy", proxy)("isproxy", false);
         auto accountPermissions = get_account_permissions(tx_permission, {proxy, config::active_name});
         send_actions({create_action(accountPermissions, config::system_account_name, N(regproxy), act_payload)});
      });
   }
...
struct canceldelay_subcommand
{
   ...
   canceldelay_subcommand(CLI::App *actionRoot)
   {
      ...
      cancel_delay->set_callback([this] {
         ...
         fc::variant act_payload = fc::mutable_variant_object()("canceling_auth", canceling_auth)("trx_id", trx_id);
...
struct deposit_subcommand
{
   ...
   deposit_subcommand(CLI::App *actionRoot)
   {
      ...
      deposit->set_callback([this] {
         fc::variant act_payload = fc::mutable_variant_object()("owner", owner_str)("amount", amount_str);
...
struct buyrex_subcommand
{
   ...
   buyrex_subcommand(CLI::App *actionRoot)
   {
      ...
      buyrex->set_callback([this] {
         fc::variant act_payload = fc::mutable_variant_object()("from", from_str)("amount", amount_str);
         auto accountPermissions = get_account_permissions(tx_permission, {from_str, config::active_name});
         send_actions({create_action(accountPermissions, config::system_account_name, act_name, act_payload)});
      });
   }
...
struct lendrex_subcommand
{
   ...
   lendrex_subcommand(CLI::App *actionRoot)
   {
      ...
      lendrex->set_callback([this] {
         fc::variant act_payload1 = fc::mutable_variant_object()("owner", from_str)("amount", amount_str);
         fc::variant act_payload2 = fc::mutable_variant_object()("from", from_str)("amount", amount_str);
         auto accountPermissions = get_account_permissions(tx_permission, {from_str, config::active_name});
...
struct unstaketorex_subcommand
{
   ...
   unstaketorex_subcommand(CLI::App *actionRoot)
   {
      ...
      unstaketorex->set_callback([this] {
         fc::variant act_payload = fc::mutable_variant_object()("owner", owner_str)("receiver", receiver_str)("from_net", from_net_str)("from_cpu", from_cpu_str);
         auto accountPermissions = get_account_permissions(tx_permission, {owner_str, config::active_name});
         send_actions({create_action(accountPermissions, config::system_account_name, act_name, act_payload)});
      });
   }
...
struct sellrex_subcommand
{
   ...
   sellrex_subcommand(CLI::App *actionRoot)
   {
      ...
      sellrex->set_callback([this] {
         fc::variant act_payload = fc::mutable_variant_object()("from", from_str)("rex", rex_str);
         auto accountPermissions = get_account_permissions(tx_permission, {from_str, config::active_name});
         send_actions({create_action(accountPermissions, config::system_account_name, act_name, act_payload)});
      });
   }
...
struct rentcpu_subcommand
{
   ...
   rentcpu_subcommand(CLI::App *actionRoot)
   {
      ...
      rentcpu->set_callback([this] {
         fc::variant act_payload = fc::mutable_variant_object()("from", from_str)("receiver", receiver_str)("loan_payment", loan_payment_str)("loan_fund", loan_fund_str);
         auto accountPermissions = get_account_permissions(tx_permission, {from_str, config::active_name});
         send_actions({create_action(accountPermissions, config::system_account_name, act_name, act_payload)});
      });
   }
...
struct fundcpuloan_subcommand
{
   ...
   fundcpuloan_subcommand(CLI::App *actionRoot)
   {
      ...
      fundcpuloan->set_callback([this] {
         fc::variant act_payload = fc::mutable_variant_object()("from", from_str)("loan_num", loan_num_str)("payment", payment_str);
         auto accountPermissions = get_account_permissions(tx_permission, {from_str, config::active_name});
         send_actions({create_action(accountPermissions, config::system_account_name, act_name, act_payload)});
      });
   }
...
struct defcpuloan_subcommand
{
   ...
   defcpuloan_subcommand(CLI::App *actionRoot)
   {
      ...
      defcpuloan->set_callback([this] {
         fc::variant act_payload = fc::mutable_variant_object()("from", from_str)("loan_num", loan_num_str)("amount", amount_str);
         auto accountPermissions = get_account_permissions(tx_permission, {from_str, config::active_name});
         send_actions({create_action(accountPermissions, config::system_account_name, act_name, act_payload)});
      });
   }
...
struct mvtosavings_subcommand
{
   ...
   mvtosavings_subcommand(CLI::App *actionRoot)
   {
      ...
      mvtosavings->set_callback([this] {
         fc::variant act_payload = fc::mutable_variant_object()("owner", owner_str)("rex", rex_str);
         auto accountPermissions = get_account_permissions(tx_permission, {owner_str, config::active_name});
         send_actions({create_action(accountPermissions, config::system_account_name, act_name, act_payload)});
      });
   }
...
struct rexexec_subcommand
{
   ...
   rexexec_subcommand(CLI::App *actionRoot)
   {
      ...
      rexexec->set_callback([this] {
         fc::variant act_payload = fc::mutable_variant_object()("user", user_str)("max", max_str);
...
int main(int argc, char **argv)
{
   ...
   getTable->set_callback([&] {
      auto result = call(get_table_func, fc::mutable_variant_object("json", !binary)("code", code)("scope", scope)("table", table)("table_key", table_key) // not used
                         ("lower_bound", lower)("upper_bound", upper)("limit", limit)("key_type", key_type)("index_position", index_position)("encode_type", encode_type)("reverse", reverse)("show_payer", show_payer));
   ...
   getScope->set_callback([&] {
      auto result = call(get_table_by_scope_func, fc::mutable_variant_object("code", code)("table", table)("lower_bound", lower)("upper_bound", upper)("limit", limit)("reverse", reverse));
      std::cout << fc::json::to_pretty_string(result)
                << std::endl;
   });
   ...
   get_balance->set_callback([&] {
      auto result = call(get_currency_balance_func, fc::mutable_variant_object("account", accountName)("code", code)("symbol", symbol.empty() ? fc::variant() : symbol));
   ...
   get_currency_stats->set_callback([&] {
      auto result = call(get_currency_stats_func, fc::mutable_variant_object("json", false)("code", code)("symbol", symbol));
   ...
   getActions->set_callback([&] {
      ...
      else
      {
         ...
         cout << "#" << setw(5) << "seq"
              << "  " << setw(24) << left << "when"
              << "  " << setw(24) << right << "contract::action"
              << " => " << setw(13) << left << "receiver"
              << " " << setw(11) << left << "trx id..."
              << " args\n";
         cout << "================================================================================================================\n";
   ...
   */
   ...
   contractSubcommand->set_callback([&] {
      if (!contract_clear)
         EOS_ASSERT(!contractPath.empty(), contract_exception, " contract-dir is null ", ("f", contractPath));
      shouldSend = false;
      set_code_callback();
      set_abi_callback();
      if (actions.size())
   ...
   stopKeosd->set_callback([] {
      ...
      if (!v.is_object() || v.get_object().size() != 0)
      { //on success keosd responds with empty object
   ...
   sign->add_option("transaction", trx_json_to_sign,
                    localized("The JSON string or filename defining the transaction to sign"), true)
       ->required();
   ...
   actionsSubcommand->add_option("account", contract_account,
                                 localized("The account providing the contract to execute"), true)
       ->required();
   actionsSubcommand->add_option("action", action,
                                 localized("A JSON string or filename defining the action to execute on the contract"), true)
       ->required();
   ...
   propose_action->set_callback([&] {
      ...
      auto args = fc::mutable_variant_object()("proposer", proposer)("proposal_name", proposal_name)("requested", requested_perm_var)("trx", trx_var);
   ...
   review->set_callback([&] {
      const auto result1 = call(get_table_func, fc::mutable_variant_object("json", true)("code", "eosio.msig")("scope", proposer)("table", "proposal")("table_key", "")("lower_bound", name(proposal_name).value)("upper_bound", name(proposal_name).value + 1)
                                // Less than ideal upper_bound usage preserved so cleos can still work with old buggy nodeos versions
      ...
      if (show_approvals_in_multisig_review)
      {
         ...
         try
         {
            const auto &result2 = call(get_table_func, fc::mutable_variant_object("json", true)("code", "eosio.msig")("scope", proposer)("table", "approvals2")("table_key", "")("lower_bound", name(proposal_name).value)("upper_bound", name(proposal_name).value + 1)
                                       // Less than ideal upper_bound usage preserved so cleos can still work with old buggy nodeos versions
                                       // Change to name(proposal_name).value when cleos no longer needs to support nodeos versions older than 1.5.0
                                       ("limit", 1));
         ...
         {
            const auto result3 = call(get_table_func, fc::mutable_variant_object("json", true)("code", "eosio.msig")("scope", proposer)("table", "approvals")("table_key", "")("lower_bound", name(proposal_name).value)("upper_bound", name(proposal_name).value + 1)
                                      // Less than ideal upper_bound usage preserved so cleos can still work with old buggy nodeos versions
                                      // Change to name(proposal_name).value when cleos no longer needs to support nodeos versions older than 1.5.0
                                      ("limit", 1));
         ...
         if (new_multisig)
         {
            ...
            {
               const auto result4 = call(get_table_func, fc::mutable_variant_object("json", true)("code", "eosio.msig")("scope", "eosio.msig")("table", "invals")("table_key", "")("lower_bound", a.first.value)("upper_bound", a.first.value + 1)
                                         // Less than ideal upper_bound usage preserved so cleos can still work with old buggy nodeos versions
                                         // Change to name(proposal_name).value when cleos no longer needs to support nodeos versions older than 1.5.0
                                         ("limit", 1));
   ...
   auto approve_or_unapprove = [&](const string &action) {
      ...
      auto args = fc::mutable_variant_object()("proposer", proposer)("proposal_name", proposal_name)("level", perm_var);
   ...
   invalidate->set_callback([&] {
      auto args = fc::mutable_variant_object()("account", invalidator);
   ...
   cancel->set_callback([&]() {
      ...
      auto args = fc::mutable_variant_object()("proposer", proposer)("proposal_name", proposal_name)("canceler", canceler);
   ...
   exec->set_callback([&] {
      ...
      auto args = fc::mutable_variant_object()("proposer", proposer)("proposal_name", proposal_name)("executer", executer);
   ...
   wrap_exec->set_callback([&] {
      ...
      auto args = fc::mutable_variant_object()("executer", executer)("trx", trx_var);
